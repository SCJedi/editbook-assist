 ...
 */
/**
 * Initialize NEW ROUTE button and confirmation dialog
 */
function initNewRoute() {
  ...
  if (btnConfirm) {
    btnConfirm.addEventListener('click', () => {
      const keysToRemove = [
        'editbook-equipment-config', 'editbook-addresses', 'editbook-route-info',
        'editbook-address-annotations', 'editbook-street-colors', 'editbook-filename',
        'editbook-backups', 'editbook-pending-apply'
      ];
